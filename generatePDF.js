...
async function callAdobeDocGenerationAPI(creditMemoJson) {
    ...
    const documentMerge = PDFToolsSdk.DocumentMerge, documentMergeOptions = documentMerge.options, options = new documentMergeOptions.DocumentMergeOptions(creditMemoJson, documentMergeOptions.OutputFormat.PDF);
